...
class NoteViewAPITest(TestCase):
    ...
    def setUp(self):
        self.client = Client()
        self.user1 = User.objects.create(username='amitksms97', email='amitksms97@gmail.com',
                                         password='pbkdf2_sha256$216000$wpomR1uhDsTl$D0YbscCIh/iE209f4G8fAoEXc059EInf1FILvDVOcrM=')
        self.user2 = User.objects.create(username='admin', email='admin@gmail.com',
                                         password='pbkdf2_sha256$216000$wpomR1uhDsTl$D0YbscCIh/iE209f4G8fAoEXc059EInf1FILvDVOcrM=')
        ...
        self.valid_collaborator_payload = {
            'collaborator': 'admin@gmail.com'
        }

        self._invalid_collaborator_payload = {
            'collaborator': 'admin123'
        }
